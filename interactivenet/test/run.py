...
def AnalyzeResults(mlflow, outputs:list, postprocessing:Dict[str, str], metadata:dict, label:bool=False):
    # Transforms
    ...
    for output in outputs:
        ...
        pred = argmax(pred)
        pred = ApplyPostprocessing(pred, postprocessing["postprocessing"])
